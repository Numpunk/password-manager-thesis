...
public class ConfirmationCodeInput : MonoBehaviour //IDENTICAL TO VerificationCodeInput class
{
    ...
    public static ConfirmationCodeInput instance;
    private void Awake()
    {
    ...
    public void OnValueChanged()
    {
        ...
        if (input.Length == 6)
        {
            UserAuthManager.instance.Set6DigitInputValueLogin(input);
        }
    }
    public void Set6Digits()
    {
        ...
        {
            UserAuthManager.instance.Set6DigitInputValueLogin(inputField.text);
        }
    }
